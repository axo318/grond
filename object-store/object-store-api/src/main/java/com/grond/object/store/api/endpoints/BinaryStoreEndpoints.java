...
public interface BinaryStoreEndpoints {
    ...
    String GET_BINARY_PATH = "/{id}";
    String APPEND_BINARY_PATH = "/append";
    String CREATE_BINARY_PATH = "";
    String DELETE_BINARY_PATH = "/{id}";

    @GetMapping(BinaryStoreEndpoints.GET_BINARY_PATH)
    BinaryKeyValue getBinaryKeyValue(@PathVariable String id);
    ...
    BinaryKeyValue appendBinaryKeyValue(@RequestBody BinaryKeyValue request);

    @DeleteMapping(BinaryStoreEndpoints.DELETE_BINARY_PATH)
    void deleteBinaryKeyValue(@PathVariable String id);
